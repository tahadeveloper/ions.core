...
return [
    ...
    'middleware_aliases' => [
        ...
        // Web session auth: loads the session user onto the request's
        // 'auth_user' attribute (the Gate + 'verified' middleware read it).
        'web.auth' => \App\Http\Middleware\SessionAuthMiddleware::class,
